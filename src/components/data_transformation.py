...
from sklearn.impute import SimpleImputer # To handle the nan values
...
class DataTransformerConfig: # Input for Data Transformation components
...
class DataTransformation:
    ...
    def get_data_transformer_object(self): #Transformation code llike encodeing, scaling etc
        """
        ...
        # Categorical variables transformation
            ...
            ("one_hoy_encoder",OneHotEncoder()),
            ("scaler", StandardScaler(with_mean=False))
            ]
        )

            logging.info("Categorical Variables encoding completed")
